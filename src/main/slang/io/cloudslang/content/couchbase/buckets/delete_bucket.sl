...
########################################################################################################################
#!!
#! @description: This operation deletes the specified bucket.
#!               'https://developer.couchbase.com/documentation/server/4.6/rest-api/rest-bucket-delete.html'
#!               Note: Bucket deletion is a synchronous operation. When a cluster has multiple servers, some
#!               servers might not be able to delete the bucket within the standard 30 second timeout period.
#!               If the bucket is deleted on all servers within the standard timeout of 30 seconds, a 200 response code
#!               is returned. If the bucket is not deleted on all servers within the 30 second timeout, a 500 error code
#!               is returned. If the bucket is not deleted on all servers and another request is made to delete the bucket,
#!               a 404 error code is returned.
#!               If the bucket is not deleted on all servers and a request is made to crate a new bucket with the same
#!               name, an error might be returned indicating that the bucket is still being deleted.
#!
...
#!                    Default: 'true'
#!                    Optional
#! @input bucket_name: Name of the bucket to be deleted.
#!
#! @output return_code: '0' if operation was successfully executed, '-1' otherwise.
#! @output return_result: A map with strings as keys and strings as values that contains information about the deleted bucket.
#! @output exception: Exception if there was an error when executing, empty otherwise.
#!
#! @result SUCCESS: The specified bucket has been deleted successfully.
#! @result FAILURE: An error occurred while trying to delete the specified bucket.
#!!#
########################################################################################################################
