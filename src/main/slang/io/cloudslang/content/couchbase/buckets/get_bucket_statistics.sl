...
########################################################################################################################
#!!
#! @description: This operation is used to retrieve usage statistics for a specified bucket.
...
#!                    Default: 'true'
#!                    Optional
#! @input bucket_name: Name of the bucket to retrieve information from.
#!
#! @output return_code: '0' if operation was successfully executed, '-1' otherwise.
#! @output return_result: A map with strings as keys and strings as values that contains information about the usage
#!                        statistics for the specified bucket.
#! @output exception: Exception if there was an error when executing, empty otherwise.
#!
#! @result SUCCESS: Usage statistics about the specified bucket have been retrieved successfully.
#! @result FAILURE: An error occurred while trying to retrieve the usage statistics for the specified bucket.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action: 
    ...
    class_name: 'io.io.cloudslang.content.couchbase.actions.buckets.GetBucketStatistics'
    method_name: 'execute'
