...
########################################################################################################################
#!!
#! @description: This operation is used to retrieve specified bucket details information.
#!
...
#! @output return_result: A map with strings as keys and strings as values that contains information about a bucket.
#! @output exception: Exception if there was an error when executing, empty otherwise.
#!
#! @result SUCCESS: Information about the specified bucket retrieved successfully.
#! @result FAILURE: An error occurred while trying to get information about the specified bucket.
#!!#
########################################################################################################################
