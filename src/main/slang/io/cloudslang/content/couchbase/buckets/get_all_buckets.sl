...
########################################################################################################################
#!!
#! @description: This operation retrieves information about all the buckets from a specified cluster.
...
#! @output return_result: A map with strings as keys and strings as values that contains information about
#!                        all the available buckets for the specified cluster.
#! @output exception: Exception if there was an error when executing, empty otherwise.
#!
#! @result SUCCESS: The list with all the available buckets has been retrieved successfully.
#! @result FAILURE: An error occurred while trying to retrieve the list of all the available buckets.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action: 
    ...
    class_name: 'io.io.cloudslang.content.couchbase.actions.buckets.GetAllBuckets'
    method_name: 'execute'
