...
########################################################################################################################
#!!
#! @description: This operation sets the recovery type to be performed for a node.
#!               Note: Recovery options are delta node recovery or full recovery. The recovery type for a node is set
#!               after the node is failed over and before rebalance. Rebalance is required to apply the recovery.
...
#!                    Default: 'true'
#!                    Optional
#! @input internal_node_ip_address: Indicates a specific node to set recovery for.
#!                                  Example: 'ns_2@10.0.0.2'
#!                                  Optional
#! @input recovery_type: Recovery type to be performed at rebalancing nodes.
#!                       Valid: "full", "delta"
#!                       Default: ''
#!                       Optional
#!
...
#!
#! @result SUCCESS: Recovery type has been successfully performed for the specified node.
#! @result FAILURE: An error occurred while trying to set the recovery type to be performed for the specified node.
#!!#
########################################################################################################################
