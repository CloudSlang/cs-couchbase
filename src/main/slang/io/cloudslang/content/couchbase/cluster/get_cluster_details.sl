...
########################################################################################################################
#!!
#! @description: This operation retrieves cluster details.
...
#! @output return_result: A map with strings as keys and strings as values that contains details about a cluster.
#! @output exception: Exception if there was an error when executing, empty otherwise.
#!
#! @result SUCCESS: Details about the specified cluster retrieved successfully.
#! @result FAILURE: An error occurred while trying to get details about the specified cluster.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action: 
    ...
    class_name: 'io.io.cloudslang.content.couchbase.actions.cluster.GetClusterDetails'
    method_name: 'execute'
