...
########################################################################################################################
#!!
#! @description: This operation retrieves cluster information.
...
#! @output return_result: A map with strings as keys and strings as values that contains information about a cluster.
#! @output exception: Exception if there was an error when executing, empty otherwise.
#!
#! @result SUCCESS: Information about the specified cluster retrieved successfully.
#! @result FAILURE: An error occurred while trying to get information about the specified cluster.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action: 
    ...
    class_name: 'io.io.cloudslang.content.couchbase.actions.cluster.GetClusterInfo'
    method_name: 'execute'
